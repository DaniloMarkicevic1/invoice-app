...
import { LogoImg, AvatarImg } from '../../Images';
// import { ReactComponent as LightTheme } from '../../assets/icon-moon.svg';
// import { ReactComponent as DarkTheme } from '../../assets/icon-sun.svg';

function Header(props, { themeToggler }) {
    console.log(props);
    return (
        <StyledHeader>
            <LogoBg>
